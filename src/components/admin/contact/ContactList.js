...
const ContactList = () => {
    ...
    const handleShow = (id) => {
        ...
        if (id) {
            axios.get(`http://localhost:8081/contact/get/${id}`)
    ...
    const handleSubmit = () => {
        if (formData.id) {
            ...
            axios.put(`http://localhost:8081/contact/update/${formData.id}`, formData)
                .then(response => {
            ...
            axios.post('http://localhost:8081/contact/create', formData)
                .then(response => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8081/contact/all')
